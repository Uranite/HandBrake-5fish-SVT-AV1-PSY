...
pkgname=(
  'handbrake-5fish-svt-av1-psy-llvm-optimized'
  'handbrake-5fish-svt-av1-psy-llvm-optimized-cli'
)
...
source=("HandBrake::git+https://github.com/HandBrake/HandBrake.git" "HandBrake-5fish-SVT-AV1-PSY::git+https://github.com/Uranite/Handbrake-5fish-SVT-AV1-PSY.git")
...
build() {
  ./HandBrake-5fish-SVT-AV1-PSY/patch.sh
  setup_compiler
...
package_handbrake-5fish-svt-av1-psy-llvm-optimized() {
...
package_handbrake-5fish-svt-av1-psy-llvm-optimized-cli() {
